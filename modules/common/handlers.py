...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        "👋 <b>Привет! Я бот для работы с Яндекс Диском и GitHub.</b>\n\n"
        "📋 <b>Основные команды:</b>\n"
        "• /menu - показать главное меню\n"
        "• /token - настроить OAuth токен Яндекс Диска\n"
        "• /github - меню GitHub\n"
        "• /help - подробная справка по использованию\n\n"
        "📎 <b>Яндекс Диск:</b> Отправь файл — загружу и пришлю ссылку\n"
        "🐙 <b>GitHub:</b> Issues, PR, управление репозиториями\n\n"
        "Начни с настройки: /token или /github",
        parse_mode="HTML",
...
async def cmd_help(message: Message) -> None:
    ...
    await message.answer(
        ...
        "<b>🐙 GitHub:</b>\n"
        "• /github — меню GitHub\n"
        "• /gh_token — подключить GitHub (Personal Access Token)\n"
        "• /repo add owner/name — добавить репозиторий\n"
        "• /repo list — список репозиториев\n"
        "• /repo set owner/name — репозиторий по умолчанию\n"
        "• /issue Текст — создать issue\n"
        "• /issues — список issues\n"
        "• /issue_close 123 — закрыть issue\n"
        "• /prs — список Pull Requests\n"
        "• /pr 15 — детали PR"
    )
